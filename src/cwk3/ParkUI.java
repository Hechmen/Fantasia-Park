...
public class ParkUI
{
    ...
    {
        System.out.println("Enter ID of the card: ");
    ...
    private void moveNow()
    {
        ...
        int id = reader.nextInt();
        reader.nextLine();
        System.out.println("Enter code of the bridge: ");
        String code = reader.nextLine();
        
        System.out.println("Move result: " + fantasia.move(id, code));
    }
